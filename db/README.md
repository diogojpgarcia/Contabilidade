...
| `migrations/002_client_mutation_id.sql` | Coluna `client_mutation_id` + índice UNIQUE para idempotência das escritas offline (fecha a janela de duplicação no flush) | ⬜ a aplicar |
